...
export const RACQUETS: Racquet[] = [
  ...
  {
    "id": "wilson-python-98-2026",
    "name": "Wilson Python 98 323g",
    "year": 2026,
    "headSize": 98,
    "length": 27,
    "strungWeight": 323,
    ...
    "frameProfile": "Aero-oriented spin platform; throat shaping for RHS (prototype / retail TBD)",
    "identity": "Precision Spin Blade",
    "notes": "DRAFT — Wilson has not published a full spec sheet. Numbers align to the in-repo Babolat Pure Aero 98 2026 platform for same-category comparison; early impressions (Reddit, tennis press) describe PA98-like spin with more connected / box-beam-adjacent feel. Other patterns (e.g. 16x19, 18x20) may ship as separate SKUs — replace this row when official specs land."
  },
  {
  ...
  {
    "id": "mizuno-acrospeed-300-2026",
    "name": "Mizuno Acrospeed 300 318g",
    "year": 2026,
    "headSize": 100,
    "length": 27,
    "strungWeight": 318,
    ...
    "frameProfile": "Variable beam with Booster Grommet system, Enerzy beam construction, Dual Spring layup",
    "identity": "Power Spin Machine",
    "notes": "Modern player's racquet combining raw speed with easy power and spin. Booster Grommet system increases dwell time and bite. Enerzy beam reduces deformation, Dual Spring carbon fiber returns extra energy."
  },
  {
    "id": "mizuno-acrostrike-305-2026",
    "name": "Mizuno Acrostrike 305 323g",
    "year": 2026,
    "headSize": 98,
    "length": 27,
    "strungWeight": 323,
    ...
    "frameProfile": "Flexible beam with 4WP Grommet system, Enerzy Beam construction, Dual Spring layup",
    "identity": "Control Precision",
    "notes": "Controllable power with great feel for intermediate/advanced players. 98 sq inch head with flexible beam for accuracy. 4WP Grommet system helps strings snap back for spin."
  },
  {
    "id": "mizuno-acrostrike-290-2026",
    "name": "Mizuno Acrostrike 290 303g",
    "year": 2026,
    "headSize": 98,
    "length": 27,
    "strungWeight": 303,
...
export const FRAME_NOVELTY_PROFILE: Record<string, FrameNoveltyProfile> = {
  "babolat-pure-aero-100-2023": {
    "bucketKey": "midplus|16x19|standard",
    "bucketSize": 45,
    "rarityScore": 0.24,
    "bands": {
      "headSize": "midplus",
      "weight": "standard",
      "swingweight": "balanced",
      "stiffness": "modern",
      "beam": "thick",
      "density": "open",
      "pattern": "16x19"
  ...
  "head-speed-mp-legend-2025": {
    ...
    "rarityTags": [
      ...
      {
        "id": "plushTech",
        "label": "soft flex plus comfort tech",
        "score": 0.12
      },
      {
        "id": "comfortTechHeavy",
        "label": "comfort-heavy tech package",
        "score": 0.12
      }
    ],
    "hintWeights": {
  ...
  "babolat-pure-aero-100-2026": {
    ...
    "rarityTags": [
      ...
      {
        "id": "spinTechHeavy",
        "label": "spin-focused tech package",
        "score": 0.12
      },
      {
        "id": "comfortTechHeavy",
  ...
  "yonex-muse-100-2026": {
    "bucketKey": "midplus|16x18|standard",
    "bucketSize": 3,
    "rarityScore": 0.83,
    "bands": {
      "headSize": "midplus",
  ...
  "head-gravity-pro-2025": {
    ...
    "rarityTags": [
      ...
      {
        "id": "thinBeamPlow",
        "label": "thin beam with plow-through",
        "score": 0.14
      }
    ],
    "hintWeights": {
  ...
  "head-gravity-mp-2025": {
    "bucketKey": "midplus|16x20|standard",
    "bucketSize": 3,
    "rarityScore": 0.35,
    "bands": {
      "headSize": "midplus",
  ...
  "head-speed-team-2026": {
    "bucketKey": "oversize|16x19|light",
    "bucketSize": 23,
    "rarityScore": 0.16,
    "bands": {
      "headSize": "oversize",
  ...
  "head-gravity-team-2025": {
    "bucketKey": "oversize|16x20|light",
    "bucketSize": 7,
    "rarityScore": 0,
    "bands": {
      "headSize": "oversize",
  ...
  "wilson-blade-104-v9": {
    "bucketKey": "oversize|16x19|standard",
    "bucketSize": 4,
    "rarityScore": 0.36,
    "bands": {
      "headSize": "oversize",
  ...
  "wilson-ultra-108-v4": {
    "bucketKey": "oversize|16x18|light",
    "bucketSize": 4,
    "rarityScore": 0.44,
    "bands": {
      "headSize": "oversize",
  ...
  "diadem-elevate-98-v3-lite": {
    "bucketKey": "players|16x20|standard",
    "bucketSize": 1,
    "rarityScore": 0.35,
    "bands": {
      "headSize": "players",
  ...
  "volkl-v8-pro-2023": {
    "bucketKey": "midplus|18x20|standard",
    "bucketSize": 1,
    "rarityScore": 0.59,
    "bands": {
      "headSize": "midplus",
  ...
  "wilson-blade-98s-2015": {
    "bucketKey": "players|18x20|standard",
    "bucketSize": 1,
    "rarityScore": 0.65,
    "bands": {
      "headSize": "players",
  ...
  "wilson-burn-100s-cv-318g-2017": {
    "bucketKey": "midplus|18x16|standard",
    "bucketSize": 1,
    "rarityScore": 0.51,
    "bands": {
      "headSize": "midplus",
