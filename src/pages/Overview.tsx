    ...
    <section className="workspace-mode" id="mode-overview" data-mode="overview">
      ...
      <div id="empty-state" className="flex flex-col items-center justify-center min-h-[75vh] w-full px-4 md:px-8">
        <div className="w-full max-w-4xl flex flex-col gap-12 relative">
          ...
          <button className="group w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-8 bg-transparent border border-dc-border hover:border-dc-platinum transition-all cursor-pointer text-left" id="fmb-cta" onClick={() => window.openFindMyBuild?.()}>
      ...
      <div id="find-my-build" className="fmb-wizard hidden">
        ...
        <div className="fmb-header">
          <button className="fmb-close" id="fmb-close" onClick={() => window.closeFindMyBuild?.()} title="Close">&times;</button>
        </div>
        ...
        <div className="fmb-nav">
          <button className="fmb-back" id="fmb-back" onClick={() => window.fmbBack?.()}>Back</button>
          <button className="fmb-next" id="fmb-next" onClick={() => window.fmbNext?.()}>Next</button>
        </div>
      </div>
